 ...
 */
export function getIpeaRegionalLevel(nivnome: string | null | undefined): RegionalLevel {
  switch (nivnome) {
    case 'Regiões': return 'regions'
    case 'Estados': return 'states'
    case 'Municípios': return 'municipalities'
